...
// HAPUS baris ini:
// const String baseUrl = "http://cloudbot.biz.id:4019";
...
class _LoginPageState extends State<LoginPage> with TickerProviderStateMixin {
  ...
  Future<void> _loadBaseUrlAndInit() async {
    ...
    try {
      ...
      if (_retryCount < 3) {
        ...
        setState(() {
          _baseUrl = "http://cloudbot.biz.id:4019";
          _isLoadingConfig = false;
        });
  ...
  void _initVideoPlayer() {
    _videoController = VideoPlayerController.asset('assets/videos/gojo.mp4')
      ..initialize().then((_) {
        if (mounted) {
          setState(() {});
            ...
            TextButton.icon(
              onPressed: () async {
                ...
                if (await canLaunchUrl(uri)) {
                  ...
                  await launchUrl(Uri.parse("https://t.me/Marzzz_Reals01"),
