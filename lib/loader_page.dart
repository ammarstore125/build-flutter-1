...
class _DashboardPageState extends State<DashboardPage> with SingleTickerProviderStateMixin {
  ...
  Widget _buildJoinCommunityButton() {
    return GestureDetector(
      onTap: () {
        _launchUrl('https://t.me/nightfold1');
      },
      child: Container(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              ...
              _buildSocialButton(
                ...
                onTap: () => _launchUrl('https://t.me/Marzzz_Reals01'),
              ),
          ...
          // Footer Text
          Text(
            'Selalu nantikan project terbaru dari TEAM NIGHT FOLD',
            style: TextStyle(
